      ...
      <div className="hidden lg:flex w-5/12 bg-brand-primary flex-col justify-center px-14 py-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-base mb-10 leading-relaxed">
            Create your free account and start planning the wedding of your dreams.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12 bg-app-bg">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-ink-muted text-sm">Start planning your perfect day, for free</p>
          </div>

          {error && (
            <div className="mb-5 p-4 bg-danger/8 border border-danger/20 rounded-xl text-danger text-sm">
              {error}
            </div>
          )}
